...
function getQuerystring(key, default_) {
	...
	var listar = function(){
		...
		var idEvent = getQuerystring('data');
		var table = $("#reportes").DataTable({
			...
			"ajax":{
				"method":"POST",
				"url": "../php/reportesEnEventos/showDataReport.php?idEvent="+idEvent
			},
			...
			"columns":[
				...
				{"data":"priority"},
				{"defaultContent": "<button type='button' class='detalle btn btn-primary'><i class='fa fa-user'></i></button>"}
			],
	...
	var editar = function(){
		$("#editar-reporte").on("click", function(){
			...
			$.ajax({
				method: "POST",
				url: "../php/reportesEnEventos/editReportNoCategorizado.php",
				data: {
	...
	var asignarReporte = function(){
		$("#asignar-reporte").on("click", function(){
			...
			$.ajax({
				method: "POST",
				url: "../php/reportesEnEventos/asignarReporte.php",
				data: {
