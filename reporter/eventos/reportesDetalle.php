...
<head>
    ...
    <script src="../js/adminJS/loadReportesGeneradosForEvents.js"></script>
    <script src="../js/adminJS/loadDataCategoriaForReport.js"></script>
    <script src="../js/adminJS/loadDataEventosForReport.js"></script>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Reportes registrados en evento seleccionado</h1>
