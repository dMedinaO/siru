        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Generar un nuevo reporte: Qué Sucedió?</h1>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h3 class="panel-title">Seleccione Categoría
                                </h3>
                            </div>
                            <div class="panel-body">
                              ...
                              <div class="row">
                                ...
                                <?php
                                  ...
                                  $query = "select * from categoryReport join pictureCategory on (categoryReport.idcategoryReport = pictureCategory.categoryReport)" ;
                                        ...
                                        echo "<div class=\"panel pos-rel\">";
                                          echo "<div class=\"pad-all text-center\">";
                                            echo "<div class=\"widget-control\">";
                                              echo "</div>";
                                                echo "<a href=\"../fechas/?category=".$data['nameCategory']."&idcategory=".$data['idcategoryReport']."&sector=".$_REQUEST['sector']."&subsector=".$_REQUEST['subsector']."&idSubsector=".$_REQUEST['idsubsector']."\">";
                                                  echo "<img alt=\"Profile Picture\" class=\"img-lg mar-ver\" src=\"../../../admin/resource/pictureCategory/".$data['namePictureCategory']."\">";
                                                    echo "<p class=\"text-lg text-semibold mar-no text-main\">".$data['nameCategory']."</p>";
                                                      echo"</a>";
                                                  echo "</div>";
                                              echo "</div>";
                                      echo "</div>";
