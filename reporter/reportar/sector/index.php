                  ...
                  <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h3 class="panel-title">Seleccione la Ubicación</h3>
                            </div>
                                        ...
                                        echo "<div class=\"panel pos-rel\">";
                                          echo "<div class=\"pad-all text-center\">";
                                            echo "<div class=\"widget-control\">";
                                              echo "</div>";
                                                echo "<a href=\"../subsector/?name=".$data['nameSector']."&value=".$data['idsector']."\">";
                                                  echo "<img alt=\"Profile Picture\" class=\"img-lg mar-ver\" src=\"../../../admin/resource/pictureSector/".$data['namePictureSector']."\">";
                                                    echo "<p class=\"text-lg text-semibold mar-no text-main\">".$data['nameSector']."</p>";
                                                      echo"</a>";
                                                  echo "</div>";
                                              echo "</div>";
                                      echo "</div>";
