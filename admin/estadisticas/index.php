...
<head>
    ...
    <script src="../js/adminJS/reportByCategory.js"></script>
    <script src="../js/adminJS/eventsByStage.js"></script>
    <script src="../js/adminJS/LoadDataReportesByZoneByCategory.js"></script>
    <script src="../js/adminJS/LoadDataReportesByDateByCategory.js"></script>
                ...
                <div id="page-content">
                  ...
                  <div class="col-sm-6 col-md-6">
                        ...
                        <div class="col-sm-6 col-md-6">
            					            ...
            					            <div class="panel">
            					                 <div class="panel-heading">
            					                     <h3 class="panel-title">Eventos según Estado Actual</h3>
            					                 </div>
            					                 <div class="panel-body">
            					                    <div id="eventsStage"></div>
            					                 </div>
            					             </div>
            					            <!---------------------------------->
