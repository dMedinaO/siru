...
<head>
    ...
    <script src="../js/adminJS/loadNotifiersCategori.js"></script>
...
<body>
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div id="demo-custom-toolbar2" class="table-toolbar-left">
            ...
            <button id="demo-dt-addrow-btn" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="demo-pli-plus"></i> Asignar nueva categoría</button>
        </div>
            ...
            <table id="users" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                  <tr>
                          ...
                          <th class="min-tablet">Asignada</th>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="modalEliminarLabel">Eliminar Categoría a Notificador</h4>
							</div>
							<div class="modal-body">
								¿Está seguro de eliminar la categoría seleccionada para el notificador?<strong data-name=""></strong>
							</div>
							<div class="modal-footer">
								<button type="button" id="eliminar-catNot" class="btn btn-primary" data-dismiss="modal">Aceptar</button>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel">Agregar Nueva Categoría a Notificador</h4>
						</div>
						<div class="modal-body">
              ...
              <div class="form-group">
						  ...
						  <div class="form-group">
							<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
								...
								<button type="button" id="agregar-catNot" class="btn btn-success" data-dismiss="modal">Aceptar</button>
								<button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
							</div>
						  </div>
