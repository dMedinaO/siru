<?php
  ...
  $query = "select * from eventsReport join categoryReport on (categoryReport.idcategoryReport = eventsReport.categoryReport) where eventsReport.nameEvent = '$nameEvent'";
