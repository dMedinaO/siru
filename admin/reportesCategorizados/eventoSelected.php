...
<head>
    ...
    <script src="../js/adminJS/loadDataEventReportCategorizated.js">
...
<body>
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
                    ...
                    <div class="panel pos-rel">
                        <div class="pad-all text-center">
                            ...
                            <a href="#">
                                ...
                                <p class="text-lg text-semibold mar-no text-main">Evento</p>
                                <br>
                                <p class="text-sm nombreEvento"></p>
                            </a>
                        </div>
                    </div>
                    <!---------------------------------->
                ...
                <div class="col-sm-4 col-md-4">
                        ...
                        <div class="panel pos-rel">
                            <div class="pad-all text-center">
                                ...
                                <a href="#">
                                    <img alt="Profile Picture" class="img-lg img-circle mar-ver" src="../img/profile-photos/14.png">
                                    <p class="text-lg text-semibold mar-no text-main">Categoría</p>
                                    <br>
                          ...
                          <div class="panel pos-rel">
                              <div class="pad-all text-center">
                                  ...
                                  <a href="#">
                                      ...
                                      <p class="text-lg text-semibold mar-no text-main">Estado</p>
                                      <br>
                                      <p class="text-sm stageEvent"></p>
                                  </a>
                              </div>
                          </div>
                          <!---------------------------------->
          ...
          <!-- se agrega la informacion de los data table -->
          <div class="row">
        ...
        <div id="demo-custom-toolbar2" class="table-toolbar-left">
            ...
            <button id="responder" class="btn btn-primary" data-toggle="modal" data-target="#responseEvents"><i class="demo-pli-plus"></i> Responder Evento</button>
        </div>

        <div class="panel-body">
            <table id="reportes" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                  <tr>
    ...
    <div class="modal fade" id="myModalEditar" tabindex="-1" role="dialog" aria-labelledby="myModalLabelEdit" aria-hidden="true">
			<form id="frmEditar" action="" method="POST" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-lg-3" for="stage">Estado <span class="required">*</span>
                  </label>
		...
		<div class="modal fade" id="editName" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
							<h4 class="modal-title" id="myModalLabel">Editar Nombre de Evento</h4>
						</div>
						<div class="modal-body">
						...
						<form id="frmAgregar" action="" method="POST" data-parsley-validate class="form-horizontal form-label-left">
						  ...
						  <div class="form-group">
							<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
								<button type="reset" class="btn btn-primary">Resetear</button>
								<button type="button" id="editar-nombre" class="btn btn-success" data-dismiss="modal">Aceptar</button>
								<button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
							</div>
						  </div>
