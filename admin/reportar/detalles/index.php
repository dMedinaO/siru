...
<head>
    ...
    <script src="../../js/adminJS/processDetailFormReport.js"></script>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Generar un nuevo reporte: Qué Ocurrió?</h1>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h3 class="panel-title">Especifique lo que ocurrió</h3>
                            </div>
                            <div class="panel-body">
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                  <textarea id="detalleReporte" placeholder="Detalle del Reporte" rows="7" class="form-control"></textarea>
                                </div>
                              </div>

                              <br>

                              <!-- aca va la parte para subir imagenes -->
                              <form id="frmAgregarFile" action="../../php/reportes/uploadFile.php" class="dropzone" >
                                <div class="dz-default dz-message">
                                  <div class="dz-icon">
                                    <i class="demo-pli-upload-to-cloud icon-5x"></i>
                                  </div>
                					        <div>
                                    <span class="dz-text">Puedes subir una imagen arrastrándola aquí!</span>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                  ...
                                  <div class="checkbox">
          					                ...
          					                <label for="demo-remember-me">Es urgente su reporte?</label>
          					            </div>
                              ...
                              <div class="row">
                                <div class="col-lg-4 col-lg-offset-4 col-md-offset-4 col-md-4 col-sm-offset-4 col-sm-4">
                                    <button class="btn btn-block btn-success" data-toggle="modal" data-target="#modalEnviar">Enviar Reporte</button>
                                </div>
